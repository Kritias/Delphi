...
if DirectoryExists(Edit1.Text) then
  ...
  ShowMessage (Edit1.Text + ' уже существует')
...
F:=TfileStream.Create(Edit2.Text + Edit4.Text,fmOpenWrite OR fmCreate);
  ShowMessage ('Файл '+Edit2.Text + Edit4.Text + ' создан');
end;
