...
ServerSocket1.Open;
ListBox1.Items.Add('Подключенно к ' + Edit1.Text+ ':' + Edit2.Text);
except
ListBox1.Items.Add('Адресс '+ Edit1.Text + ':'+ Edit2.Text + ' недоступен');
end;
end;
...
ListBox1.Items.Add('Вы: '+ '  Hello!');

end;

procedure TForm1.ClientSocket1Read(Sender:TObject; Socket:TCustomWinSocket);
begin
ListBox1.Items.Add('Собеседник: ' + Socket.ReceiveText);
end;

procedure TForm1.Button2Click(Sender: TObject);
begin
ClientSocket1.Socket.SendText(Edit3.Text);
ListBox1.Items.Add('Вы: ' + Edit3.Text);
end;
...
ShowMessage('Сервер запущен ' + Edit4.Text);
end;
